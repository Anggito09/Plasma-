...
config.name='trefiko';config.main='./dist/server/index.js';config.assets.directory='./dist/client';config.vars={...config.vars,TREFIKO_STANDALONE:'true'};
config.d1_databases=[{binding:'DB',database_name:'trefiko',database_id:id,migrations_dir:'./drizzle'}];
