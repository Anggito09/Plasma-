...
const r = spawnSync(process.execPath, ['./node_modules/wrangler/bin/wrangler.js', 'deploy', '--config', `wrangler.${worker.replace(/^trefiko-/, '')}.json`, '--assets', './dist/client'], { stdio: 'inherit' });
